        ...
        <div class="q-pa-md row items-start q-gutter-md">
          ...
          >
            ...
            <q-card-section class="q-pt-none">
              ...
              <div class="text-caption text-grey">Rua Teste, 123</div>
            </q-card-section>
            ...
            <q-card-actions>
              ...
              <q-btn flat color="primary"> Agendar </q-btn>
            </q-card-actions>
          </q-card>
        </div>
      </q-tab-panel>
      ...
      <!-- <q-tab-panel name="saude">
        <div class="q-pa-md row items-start q-gutter-md">
          <q-card
            ...
            flat
            bordered
            v-for="(servico, id_servico) in getServicosPorCategoria('Saude')"
            :key="id_servico"
            v-show="isCategoriaSelecionada('saude')"
          >
            <q-img
              src="https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1787&q=80"
            />
      ...
      <q-tab-panel name="consertos">
        <div class="q-pa-md row items-start q-gutter-md">
          <q-card
            ...
            flat
            bordered
            v-for="(servico, id_servico) in getServicosPorCategoria('Consertos')"
            :key="id_servico"
